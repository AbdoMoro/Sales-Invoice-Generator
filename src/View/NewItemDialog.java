...
public class NewItemDialog extends javax.swing.JDialog {
    ...
    int invoiceNumber;
    public NewItemDialog(java.awt.Frame parent, boolean modal, int invoiceNumber) {
        super(parent, modal);
        initComponents();
    ...
    private void btn_OkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_OkActionPerformed
        ...
        if(txt_ItemName.getText().isEmpty() || txt_ItemPrice.getText().isEmpty() || txt_Count.getText().isEmpty())
            ...
            item = new InvoiceItem(invoiceNumber, name, price, count);
            dispose();
        }
    }//GEN-LAST:event_btn_OkActionPerformed

    public static InvoiceItem getNewItem(){
        return item;
    }
    /**
